...
- 重新应用[临时数据](https://github.com/XColorful/CBR-addon/wiki/Temp-data)（_cbraddon.json_）
- 启用进度条（已经创建的`游戏区域`不会被追踪）
- 写入[临时数据](https://github.com/XColorful/CBR-addon/wiki/Temp-data)（_cbraddon.json_）
...
- Reapply [Temp data](https://github.com/XColorful/CBR-addon/wiki/Temp-data#English) (_cbraddon.json_)
- Enable progress bar (`GameZone` already created will not be tracked)
- Write to [Temp data](https://github.com/XColorful/CBR-addon/wiki/Temp-data#English) (_cbraddon.json_)
