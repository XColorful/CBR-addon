...
import xiao.cbraddon.command.sub.ProgressBarCommand;

import static xiao.cbraddon.command.CommandArg.MOD_ID;
import static xiao.cbraddon.command.CommandArg.MOD_NAME_SHORT;
...
public class ServerCommand {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> get(String rootName) {
        ...
        root.then(ProgressBarCommand.get()
