...
public class CommandArg extends xiao.battleroyale.command.CommandArg {

    public static final String MOD_ID = CbrAddon.MOD_ID;
    public static final String MOD_NAME_SHORT = CbrAddon.MOD_NAME_SHORT;
