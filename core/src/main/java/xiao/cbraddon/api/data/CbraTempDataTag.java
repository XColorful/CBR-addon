package xiao.cbraddon.api.data;

import xiao.cbraddon.CbrAddon;
import xiao.cbraddon.config.common.game.zone.ProgressBarProtocol057;

public class CbraTempDataTag {
    ...
    public static final String MOVE_TIME_COLOR = ProgressBarProtocol057.MOVE_TIME_COLOR;
    public static final String MOVE_TIME_OVERLAY = ProgressBarProtocol057.MOVE_TIME_OVERLAY;
}
